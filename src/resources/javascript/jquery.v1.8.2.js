		...
		*/
		...
		ajax: function(url, options) {
			...
			if (s.crossDomain == null) {
				...
				s.crossDomain = parts && (parts.join(":") + (parts[3] ? "" : parts[1] ===
					"http:" ? 80 : 443)) !== (ajaxLocParts.join(":") + (ajaxLocParts[3] ?
...
(function($) {
	...
	Drupal.formatPlural = function(count, singular, plural, args, options) {
		...
		var index = Drupal.locale.pluralFormula ? Drupal.locale.pluralFormula(args[
			'@count']) : ((args['@count'] == 1) ? 0 : 1);
		if (index == 0) {
	...
	Drupal.ajaxError = function(xmlhttp, uri) {
		...
		message = statusCode + pathText + statusText + responseText +
			readyStateText;
		return message;
	};
